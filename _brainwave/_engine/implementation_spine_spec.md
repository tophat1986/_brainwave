...
5. `implementation-synthesize <authored-by> [proposal-path]` imports allowed structural fields, supplies command-owned delivery defaults, validates the complete proposal, and records a proposal fingerprint.
