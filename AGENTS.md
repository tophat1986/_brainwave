...
- If the implementation spine is absent, compile it, refine its provisional slices, obtain explicit user approval, and approve the plan before downstream product work.
