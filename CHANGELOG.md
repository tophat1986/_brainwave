...
- Cursor, Claude Code, and Codex session adapters backed by one neutral runtime.
- Lifecycle, seed-integrity, scope, scaffolding, dashboard, and clean-install validation.
- Optional hook integration with a documented static-guidance fallback.
- MIT licence.
...
- Added module-linked assurance: mandatory inherited DNA profiles, consequential minimum levels, sealed slice methods and evidence shapes, bounded revision-bound review packets, stable findings with remediation and recheck, and guarded QA closure.
- Added proportionate experience assurance with recorded component/browser harness decisions, visual-reference evidence, semantic journey traces, fresh-context review provenance, and a minimal dashboard QA summary.
